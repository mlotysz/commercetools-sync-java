...
class InventorySyncUtilsTest {
  ...
  @BeforeAll
  static void setup() {
    final Channel channel = InventorySyncMockUtils.getMockSupplyChannel(SUPPLY_CHANNEL_ID, "key1");
    ...
    inventoryEntry =
        InventorySyncMockUtils.getMockInventoryEntry(
            SKU, QUANTITY, RESTOCKABLE_IN_DAYS, DATE_1, reference, null);
    inventoryEntryWithCustomField1 =
        InventorySyncMockUtils.getMockInventoryEntry(
            SKU, QUANTITY, RESTOCKABLE_IN_DAYS, DATE_1, reference, customFields);
  }
